      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white rounded-lg overflow-hidden shadow-lg">
        ...
        <div className="bg-black p-8 text-white relative">
          ...
          <div className="absolute bottom-0 right-0 transform translate-x-1/4 translate-y-1/4">
            <div className="w-48 h-48 bg-gray-900 rounded-full opacity-50"></div>
          </div>
        </div>
        ...
        <div className="p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full md:w-auto px-8 py-3 bg-black text-white rounded-md hover:bg-gray-800 transition-colors duration-300"
            >
              Send Message
            </button>
          </form>
